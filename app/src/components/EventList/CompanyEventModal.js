...
//redux
import {
  setCompanyModalEvent,
  setCompanyModalOpen,
  setCompanyModalClose,
  setCompanyModalEventOccupied,
  setAccessTypeModalOpen,
  editEventAccessType,
...
const mapStateToProps = (state, props) => {
  const vis = state.showModal.companyVisibility;
  const event = state.showModal.companyEvent;
  console.log("vis: " + vis);
  return {
    visibility: vis,
    ourEvent: event,
...
export default connect(mapStateToProps)(CompanyEventModal);
