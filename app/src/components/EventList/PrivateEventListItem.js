...
import {setPrivateModalEvent,setPrivateModalOpen,setPrivateModalOccupied} from '../../redux/eventModal/eventModal-action'
...
//components
 ...
 function PrivateEventListItem({modalType,event}){
        ...
        <button class="bg-gray-400 p-2 rounded-md" onClick={()=> {
         ...
         const occ=[]
          const prom = new Promise((resolve,reject) => {
            ...
            dispatch(setPrivateModalEvent(event))
          ...
          prom.then(() => {
            ...
            dispatch(setPrivateModalOpen(true))
