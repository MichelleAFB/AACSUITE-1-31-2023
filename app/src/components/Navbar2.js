...
function Navbar2({visibility}) {
  ...
  console.log("NAVBAR2:"+visibility)
  useEffect(() => {
    ...
    const prom = new Promise((resolve,reject) => {
      ...
      if(sessionStorage.getItem("visibleAdminNavbar") &&!sessionStorage.getItem("visibleNavbar")){
        setType("admin")
        setIsLoading(false)
      }else if(!sessionStorage.getItem("visibleAdminNavbar") &&sessionStorage.getItem("visibleNavbar")){
        setType("client")
        setIsLoading(false)
      }
      resolve()
